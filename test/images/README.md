...
the host OS version. For this reason, we build test images for different Windows OS Versions: 1809, 2004,
20H2. In order add support for a new Windows OS version, a new entry for that OS version will have
